...
const About = () => {
  return (
    <div>
      ...
      {/* Section 1 */}
      <div className='grid lg:grid-cols-2  w-5/6 mx-auto gap-8 justify-center py-20 text-left'>
        <div className='grid grid-cols-1 lg:grid-cols-2  gap-4 justify-evenly align-baseline'>
          <img src="/hello.png" className='h-60 col-span-1 mt-auto' alt="" />
      ...
      {/* Section 2 */}
      <div className='grid lg:grid-cols-2 w-5/6 mx-auto py-20 text-left align-middle justify-around'>
        ...
        <div className="h-80 bg-cover bg-center  bg-red-400 rounded-lg bg-[url(/abut.svg)]"></div>
      </div>

      {/* Section 3 - Mission */}
      <div className='grid lg:grid-cols-2 w-5/6 mx-auto gap-20 justify-center py-20 text-right'>
      ...
      {/* Section 4 - Vision */}
      <div className='grid lg:grid-cols-2 w-5/6 mx-auto gap-20 justify-center py-20 text-left'>
        <img src="sick.png" className='h-96' alt="" />
        <div className='flex flex-col  text-sm space-y-4 leading-loose'>
      ...
      <Mission />
      <div className='grid lg:grid-cols-2 w-5/6 mx-auto gap-10 justify-center  py-20 text-left'>
