  ...
  return (
    <div>
       ...
       { filter.map((filter, index)=><div className='hover:bg-red-500 cursor-pointer  bg-[#FFBFBF] text-red-500  hover:text-white h-fit rounded-md px-5 py-2 text-sm'>{filter}</div>)
             ...
             <div className='grid grid-cols-1 lg:grid-cols-2 bg-[#FDE2E2] 
             my-20 w-5/6 mx-auto text-left align-middle justify-center gap-10'>
        <div className=' leading-[30px]'>
      <h3 className='text-xl font-semibold my-4 pl-10'>The Lifeline of Humanity: 
        ...
        Blood is the essence of life. Every day, thousands of people around the world rely on blood transfusions
         to survive accidents, surgeries, childbirth complications, and chronic diseases like sickle cell 
         anemia and leukemia.
         </p>
         <div className='flex gap-3 pl-10 align-middle w-full justify-between'>
          <div>by Aishat</div>
          <button className='text-white bg-black'>Read more</button>
          </div></div>
