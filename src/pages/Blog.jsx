  ...
  return (
    <div>
       ...
       { filter.map((filter, index)=><div className='hover:bg-red-500 cursor-pointer  bg-[#FFBFBF] text-red-500  hover:text-white h-fit rounded-md px-5 py-2 text-sm'>{filter}</div>)
             ...
             <div className='grid grid-cols-2 bg-[#FDE2E2] p-2 my-10
              w-full lg:w-5/6 mx-auto text-left align-middle  rounded-lg justify-center gap-2 lg:gap-10'>
      ...
      <h3 className='text-sm lg:text-xl font-semibold lg:my-4 px-2 lg:px-10'>The Lifeline of Humanity: 
        ...
        Blood is the essence of life. Every day, thousands of people around the world rely on blood and the next otlining 
        methodology  ...
         </p>
