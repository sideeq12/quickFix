...
const Steps = () => {
  return (
    <div className='relative py-20 mt-10'>
        ...
        <div className='flex py-10 w-5/6 gap-10 mx-auto'>
    <div className='bg-[#F4F4f4] rounded-md px-10 flex flex-col space-y-4 py-14 w-1/2'>
    ...
    <div  className='bg-red-500 text-white flex flex-col space-y-2  rounded-md px-5 py-14 w-1/2'>
