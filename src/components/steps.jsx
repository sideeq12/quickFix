...
const Steps = () => {
  return (
    ...
    <div className='bg-[#F4F4f4] rounded-md px-10 flex flex-col space-y-4 py-14 '>
    ...
    <div  className='bg-red-500 text-white flex flex-col space-y-2  rounded-md px-5 py-14'>
