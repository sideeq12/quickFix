         ...
         <p>Join Blood Hero and make a difference. 
             Whether you are in need of blood or want to donate, we are here to
              ...
              <div className='flex gap-4'>
                     <button className='py-2 px-4 border bg-red-500 text-sm text-white rounded-md'>
                         Join Us Today
                     </button>
                     <button className='py-2 flex px-4 border gap-2 border-red-500 text-sm text-red-500 rounded-md'>
                        <img src="/playstore.png" className='h-6' alt="" /> Play Store
                     </button>
                     <button className='py-2 px-4 border flex gap-2 border-red-500 text-sm text-red-500 rounded-md'>
                     <img src="/appstore.png" className='h-6' alt="" />  App Store
                     </button>
              </div>
     </div>
